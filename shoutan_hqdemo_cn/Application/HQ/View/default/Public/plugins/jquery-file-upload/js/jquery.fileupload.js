...
(function (factory) {
    ...
    $.widget('blueimp.fileupload', {
        ...
        options: {
            ...
            //最大文件数，通过maxNumberOfFiles获得
            maxFileslength: undefined,
        ...
        _init : function (){
            this.options.maxFileslength = this.options.maxNumberOfFiles;
        },
        ...
        _onChange: function (e) {
            ...
            if (typeof this.options.maxNumberOfFiles === 'number' && this.options.maxNumberOfFiles < data.fileInput.context.files.length) {
                custom_alert('单次上传的文件数量最多为' + this.options.maxFileslength + '个！');
                return false;
            }
