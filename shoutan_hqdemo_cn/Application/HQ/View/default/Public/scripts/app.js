...
var App = function () {
    ...
    var handleSidebarToggler = function () {
        ...
        $('.page-sidebar').on('click', '.sidebar-toggler', function (e) {
            ...
            if (body.hasClass("page-sidebar-closed")) {
                ...
                $.cookie('page-sidebar-closed', 0, {expires: 365, path: '/'});
            } else {
                body.addClass("page-sidebar-closed");
                $.cookie('page-sidebar-closed', 1, {expires: 365, path: '/'});
            }
            runResponsiveHandlers();
        });
    ...
    return {
        ...
        blockUI: function (el, centerY) {
            var el = jQuery(el);
            el.block({
                message: '<img src="' + THEME_PATH + 'Public/img/ajax-loading.gif" align="">',
