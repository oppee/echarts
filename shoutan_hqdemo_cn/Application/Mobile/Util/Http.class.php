...
class Http
{
     ...
     * @static
     * @access public
     * @param string $remote 远程URL+文件名
     * @param string $showname 下载保存文件名
     * @return void
     */
    //远程文件直接下载 (不生成本地服务器文件,可能无法读取文件大小)
    static public function remoteDownload($remote, $showname)
    {
        $expire =180;
        $length = filesize($remote);
