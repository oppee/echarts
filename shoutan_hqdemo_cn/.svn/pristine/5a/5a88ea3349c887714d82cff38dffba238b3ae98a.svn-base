...
class TbltransactiondataController extends BaseController
{
    ...
    public function index()
    {
		...
		/*if (I('request.keyword')) {
            $Where .=' and (merchant_no LIKE "%' . I('request.keyword') . '%" OR merchant_name LIKE "%' . I('request.keyword') . '%" OR device_no LIKE "%' . I('request.keyword') . '% OR transaction_amount LIKE "%' . I('request.keyword') . '%")';
        }*/
		
		if (I('request.keyword')!='') {
            $I_keyword = trim(I('request.keyword'));
            $Where .= " and (merchant_no like '%" . $I_keyword . "%' or device_no like '%" . $I_keyword . "%' or transaction_amount = '" . $I_keyword . "')";
        }
