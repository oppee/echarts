...
class Client{
	 ...
	 * @param string $serialNumber 	序列号,请通过联合维拓销售人员获取
	 * @param string $password		密码,请通过联合维拓销售人员获取
	...
	function sendSMS($mobiles=array(),$content,$sendTime='',$addSerial='',$charset='GBK',$priority=5)
	{
		...
		if(is_array($mobiles)){
			...
			$params = array('arg0'=>$this->serialNumber,'arg1'=>$this->sessionKey,'arg2'=>$sendTime,'arg3'=>'BatchSend',
			'arg4'=>$content,'arg5'=>'', 'arg6'=>'UTF-8','arg7'=>$priority
			);
		}
