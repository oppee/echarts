...
{ //类定义开始
    ...
    private function save($file)
    {
        ...
        if ($this->thumb && in_array(strtolower($file['extension']), array('gif', 'jpg', 'jpeg', 'bmp', 'png'))) {
            ...
            if (false !== $image) {
                ...
                $thumbDir = explode(',', $this->thumbDir);
                ...
                for ($i = 0, $len = count($thumbWidth); $i < $len; $i++) {
                    ...
                    $thumbfilename = $thumbPath . $thumbDir[$i] . '/' . $thumbname . '.' . $thumbExt;
                    if ($this->makeDir(dirname($thumbfilename))) {
                        if (1 == $this->thumbType) {
                            Image::thumb2($filename, $thumbfilename, '', $thumbWidth[$i], $thumbHeight[$i], true);
                        } else {
                            Image::thumb($filename, $thumbfilename, '', $thumbWidth[$i], $thumbHeight[$i], true);
                        }
                    }
                }
     ...
     * @return array
     */
    private function dealFiles($key, $files)
    {
        $fileArray = array();
        $n = 0;
        foreach ($files as $k => $file) {
